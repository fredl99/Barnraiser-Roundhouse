...
<div id="col_single">
	<div class="box" id="box_accounts">
		...
		<div class="box_body">
			...
			?>
			<li>
				<span class="openid_name"><a href="/maintain/account/<?php echo $i['user_id'];?>"><?php echo $i['user_webspace'];?></a></span>
...
<div id="col_left">
	...
	<div class="box">
		<div class="box_header">
			<h1><?php echo _("Unauthorized blog names");?></h1>
		</div>

		<div class="box_body">
			<p>
				<?php echo _("Unauthorized blog names are blog names that you do not allow. Use a comma to separate each name.");?>
			</p>
			
			<p>
				<label for="id_unauthorized_webspace_names"><?php echo _("Names");?></label>
				<input type="text" name="unauthorized_webspace_names" id="id_unauthorized_webspace_names" value="<?php echo $arr_reg['unauthorized_webspace_names'];?>" />
			</p>
			...
			<p class="buttons">
				<input type="submit" name="save_config_webspace_names" value="<?php echo _("save");?>" />
			</p>
		</div>
	</div>
...
<div id="col_right">
	...
	<div class="box">
		...
		<div class="box_body">
			<p>
				<?php echo _("A 'Maintainer' is an administrator that has access to this screen. Add a maintainers Blog name. Use a comma to separate each name.");?>
			</p>
			
			<p>
				<label for="id_maintainer_webspace_ids"><?php echo _("Account names");?></label>
				<input type="text" name="maintainer_webspace_ids" id="maintainer_webspace_ids" value="<?php echo $arr_security['maintainer_webspace_ids'];?>" />
			</p>
			
			<p class="buttons">
				<input type="submit" name="save_config_maintainer_webspace_ids" value="<?php echo _("save");?>" />
			</p>
		</div>
	</div>
