...
$core_config['php']['session_name'] = "PHPSESSIDROUNDHOUSE9697";
...
// leave empty if you want the default path for 'finfo_open'
$core_config['php']['magic_path'] = 					"";



// RELEASE NOTES ---------------------------------------------------------
$core_config['release']['version'] = 					"Alpha 0.1";
$core_config['release']['release_date'] = 				"09-24-2008"; // MM-DD-YYYY
$core_config['release']['install_date'] = "09-29-2008";
...
$core_config['db']['pass'] = "";
$core_config['db']['db'] = "barnraiser_test5_roundhouse";
$core_config['db']['prefix'] =	 						"roundhouse";
$core_config['db']['collate'] =	 						""; // utf8_swedish_ci



// URI, DOMAIN and SUB-DOMAIN CONFIGURATION -----------------------------
$core_config['script']['core_domain'] = "http://roundhouse.localhost";
// comment this out if you want a multi-user version of the blog
...
$core_config['script']['multiple_webspace_pattern'] = "/(.*?)\.roundhouse.localhost/";
...
$core_config['registration']['unauthorized_webspace_names'] = "www, ftp, http, https, barnraiser, roundhouse";
// allow registration - 1 = yes, 0 = no - Only valid when Roundhouse setup for multiple accounts
...
$core_config['security']['maintainer_webspace_ids'] = "tom, bob";
...
// EMAIL CONFIGURATION ---------------------------------------
$core_config['mail']['host'] = "mailout.telia.com";
$core_config['mail']['port'] = 				25;
$core_config['mail']['email_address'] = "info@barnraiser.org";
$core_config['mail']['from_name'] = "Barnraiser";
