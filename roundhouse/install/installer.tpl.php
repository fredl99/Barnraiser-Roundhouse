...
<head>
	...
	<title>Roundhouse installer</title>
...
<body>
	...
	<div class="box" style="border-width: 0px;">
		...
		<div class="box_body">
			<p>
				<?php
				$txt = _("This installer will install version {version} of Roundhouse. For more information on Roundhouse please visit the <a href='http://www.barnraiser.org/roundhouse'>Roundhouse product page</a>.");
	...
	<div class="box">
		...
		<div class="box_body">
			...
			<p>
				<?php
				$txt = _("Once completed please visit <a href='{url}'>your account</a> to continue.");
		...
		<div class="box">
			...
			<div class="box_body">
				...
				<div id="id_new_subdomain1">
					<p>
						<?php
						$txt = _("The domain you try to install at is {domain}. This implies blog urls will look something like this:");
				...
				<div id="id_new_subdomain2" style="display: none;">
					<p>
						<?php echo _("Give an example of how an blog url should look like.");?>
					</p>
				...
				?>
				<div id="id_new_domain1">
				<p>
					<?php
					$txt = _("Your blog address will be {domain}.");
					$domain_txt = $http . "://" . $domain;
					$txt = str_replace("{domain}", $domain_txt, $txt);
					echo $txt;
					?>
				...
				<p class="buttons">
					<input type="button" onclick="document.getElementById('id_new_domain1').style.display='none'; document.getElementById('id_new_domain').style.display='block';" value="<?php echo _("change this");?>" />
				</p>
				</div>

				<div id="id_new_domain" style="display: none;">
				<p>
					<?php echo _("Type in your blog URL.");?>
				</p>
	...
	<div id="col_right">
		<div class="box">
			...
			<div class="box_body">
				...
				<p>
					...
					<input type="text" name="user_webspace" id="id_user_webspace" value="<?php if (isset($_POST['user_webspace'])) { echo $_POST['user_webspace'];}?>" <?php if(isset($user_webspace)) { echo " readonly";}?> />
				</p>
				<?php }?>
		...
		<div class="box">
			...
			<div class="box_body">
				<p>
					<?php echo _("The installer will install Roundhouse then take you to your Blog. Click the link marked 'manage' to login. Once logged in you will see a 'maintain' link at the top of your account which will provide you with additional setup options.");?>
